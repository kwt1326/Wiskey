...
function Frame48095455() {
  return (
    <div className="absolute bg-[#b8621f] h-[52px] left-[24px] rounded-[16px] top-[724px] w-[327px]">
      <div className="absolute flex flex-col font-['Poppins:Medium',_sans-serif] justify-center leading-[0] left-[161px] not-italic text-[16px] text-center text-nowrap text-white top-[26px] translate-x-[-50%] translate-y-[-50%]">
...
export default function Wiskey() {
  return (
    <div className="bg-[#070707] relative size-full" data-name="Wiskey">
      <div className="absolute font-['Poppins:SemiBold',_sans-serif] leading-[1.5] left-[12px] not-italic text-[32px] text-nowrap text-white top-[518px] tracking-[-0.64px] whitespace-pre">
        <p className="mb-0">Ask with coins</p>
        <p>Answer with wisdom</p>
      </div>
      <GetStartedButton />
      <div className="absolute flex flex-col font-['Poppins:Medium',_sans-serif] justify-center leading-[0] left-[12px] not-italic text-[14px] text-nowrap text-white top-[647px] translate-y-[-50%]">
